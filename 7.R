...
{
  # Create a new plot for each data frame
...
{
  my_vector[i] <- i * 2  # Populate the vector with even numbers
}
...
for (i in 1:matrix_size) 
{
  ...
  {
    my_matrix[i, j] <- i * j  # Populate the matrix with multiplication results
  }
}
print(my_matrix)
...
for (i in 1:5) 
{
  element <- i * 2  # Create an element (in this case, doubling 'i')
  my_list[[i]] <- element  # Add the element to the list
}
